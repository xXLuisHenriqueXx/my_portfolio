...
const card = tv({
  slots: {
    container:
      "w-full md:w-[31.25rem] xl:w-[36.5rem] 2xl:w-[45rem] p-4 xl:px-8 2xl:p-10 lg:absolute lg:bottom-20 2xl:bottom-28 lg:right-0 bg-backgroundCard rounded-sm",
    title:
      "pt-2 text-2xl lg:text-3xl font-medium font-bebas text-lightColor text-center",
    containerIcons: "flex flex-col mt-4 xl:mt-8",
    iconsRow: "flex flex-row justify-between items-center",
    icon: "w-[4.375rem] md:w-[5.25rem] 2xl:w-[8.125rem] p-2 2xl:p-4 bg-backgroundIcon rounded-sm grayscale transition duration-500 ease-in-out hover:grayscale-0 hover:scale-110",
  },
