...
const card = tv({
  slots: {
    container:
      "flex flex-col justify-center items-center md:w-[24rem] lg:absolute lg:bottom-8 xl:bottom-10 2xl:bottom-12 bg-backgroundCard rounded-sm",
    containerIcons:
      "flex flex-row w-full items-center justify-between py-4 px-8",
